...
public class CrossChatManager {
     ...
     */
    public CrossChatManager(Message message) {
        this.message = message;
    }

    public void main(String channel, JDA jda) {
        if (channel.equals(Main.getConfig("crosschat_two_channel"))) {
            ...
            final Guild guildOne = jda.getGuildById(guildConfig);
        ...
        if (channel.equals(Main.getConfig("crosschat_one_channel"))) {
            ...
            final Guild guildTwo = jda.getGuildById(guildConfig);
